...
export const modules: ApicosuModule[] = [
  {
    ...
    path: "/error-finder",
    textPlaceholder: "SAP-Fehlermeldung, Langtext, Systemkontext oder betroffene Anwendung eingeben...",
  },
  {
    ...
    textPlaceholder: "IMG-Pfad, Customizing-Auszug, Tabellen oder Prozesskontext eingeben...",
  },
  {
    ...
    textPlaceholder: "Transportnummern, Objektliste, Importprotokoll oder Systemlandschaft eingeben...",
  },
  {
    ...
    textPlaceholder: "Prozessbeschreibung, Rollen, Tabellen, Felder oder offene Punkte eingeben...",
  },
  {
    ...
    textPlaceholder: "Prozess, Tabellen, Felder, Constraints oder gewünschte Datenstruktur eingeben...",
  },
  {
    ...
    textPlaceholder: "Prozessbeschreibung, Zielgruppe, Rollen oder Trainingsziel eingeben...",
  },
];
