...
const Pricing = () => {
  ...
  const displayPrice = (monthly: number) => {
    ...
    return (
      <>
        <span className="text-4xl font-semibold text-white">€{discounted}</span>
        <span className="pb-1 text-sm text-zinc-500">
          /Monat <span className="text-zinc-400">(statt €{monthly})</span>
        </span>
      </>
    );
  };
        ...
        <div className="grid gap-6 lg:grid-cols-5">
          ...
          <article className="flex flex-col justify-between rounded-2xl border border-[#2a2a2a] bg-[#181818] p-6 shadow-xl shadow-black/35">
            <div>
              ...
              <div className="mt-6 flex items-end gap-2">{displayPrice(prices.free)}</div>
          ...
          <article className="flex flex-col justify-between rounded-2xl border border-[#2a2a2a] bg-[#181818] p-6 shadow-xl shadow-black/35">
            <div>
              ...
              <div className="mt-6 flex items-end gap-2">{displayPrice(prices.basic)}</div>
              <ul className="mt-6 space-y-3 border-t border-[#2a2a2a] pt-6 text-sm text-zinc-300">
                <li className="flex gap-3">
                  <Check className="h-4 w-4 text-[#70bdff]" />
                  20 Analysen / Monat
                ...
                <li className="flex gap-3">
                  <Check className="h-4 w-4 text-[#70bdff]" />
                  5 Datei‑Uploads / Monat
                </li>
                <li className="flex gap-3">
                  <Check className="h-4 w-4 text-[#70bdff]" />
                  Zugriff auf 3 Module
                </li>
              </ul>
            </div>
            <Button className="mt-6 h-12 w-full rounded-2xl bg-[#0A6ED1] text-white hover:bg-[#0b7ce8]">
          ...
          <article className="flex flex-col justify-between rounded-2xl border border-[#2a2a2a] bg-[#181818] p-6 shadow-xl shadow-black/35">
            <div>
              ...
              <div className="mt-6 flex items-end gap-2">{displayPrice(prices.team)}</div>
              <ul className="mt-6 space-y-3 border-t border-[#2a2a2a] pt-6 text-sm text-zinc-300">
                <li className="flex gap-3">
                  <Check className="h-4 w-4 text-[#70bdff]" />
                  5 Pro‑Lizenzen inklusive
                </li>
                <li className="flex gap-3">
                  <Check className="h-4 w-4 text-[#70bdff]" />
                  5 Login‑Keys
