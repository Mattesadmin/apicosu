    ...
    <section className="relative mx-auto max-w-[1200px] px-5 py-10 md:px-8 md:py-16">
      <div className="mb-8 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="mb-3 text-sm font-semibold uppercase tracking-[0.22em] text-[#70bdff]">APICOSU Module</p>
          <h1 className="text-4xl font-semibold tracking-[-0.04em] text-white md:text-5xl">{module.title}</h1>
          <p className="mt-4 max-w-2xl text-base leading-8 text-zinc-300">{module.description}</p>
        </div>
      </div>
      ...
      <div className="grid gap-5 lg:grid-cols-[0.92fr_1.08fr]">
        <section className="rounded-2xl border border-[#2a2a2a] bg-[#181818] p-5 shadow-2xl shadow-black/35 md:p-6">
          <div className="mb-6">
            <h2 className="text-xl font-semibold tracking-tight text-white">Upload & Input</h2>
            <p className="mt-2 text-sm leading-6 text-zinc-400">Dateien, Screenshots oder strukturierte SAP-Informationen für die Analyse bereitstellen.</p>
          </div>
          ...
          <div className="rounded-2xl border border-dashed border-[#0A6ED1]/35 bg-[#0A6ED1]/8 p-8 text-center shadow-inner shadow-black/20">
            ...
            <p className="mt-2 text-sm leading-6 text-zinc-400">SAP-Screenshots, Exporte, Protokolle oder Dokumente auswählen.</p>
          ...
          <div className="mt-5">
            <label className="mb-2 block text-sm font-semibold text-zinc-200">Optional text input</label>
            <Textarea
          ...
          <Button className="mt-5 h-12 w-full rounded-2xl bg-[#0A6ED1] text-sm font-semibold text-white shadow-lg shadow-[#0A6ED1]/25 hover:bg-[#0b7ce8]">
            Analyze
          </Button>
        </section>
        ...
        <section className="rounded-2xl border border-[#2a2a2a] bg-[#181818] p-5 shadow-2xl shadow-black/35 md:p-6">
          <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-zinc-400">Analyseausgabe für Review, Dokumentation und Weiterverarbeitung.</p>
            </div>
            <div className="flex gap-2">
              <Button variant="outline" className="rounded-2xl border-[#2a2a2a] bg-[#101010] text-zinc-200 hover:bg-[#202020] hover:text-white">
          ...
          <div className="min-h-[410px] rounded-2xl border border-[#2a2a2a] bg-[#101010] p-5 shadow-inner shadow-black/30">
            <p className="text-sm leading-7 text-zinc-500">Analysis output will appear here.</p>
          </div>
        </section>
      </div>
    </section>
